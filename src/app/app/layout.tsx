...
export default async function AppLayout({
  ...
  const navItems: NavItem[] = isPrivate ? [
    ...
    { href: "/app/dokumente",     label: "MasterDoc",    icon: "fileText"      },
    { href: "/app/tabellen",      label: "MasterCalc",     icon: "grid"          },
    { href: "/app/praesentationen", label: "MasterSlides", icon: "monitor"   },
    ...
    { href: "/app/drive",          label: "MasterDrive",          icon: "hardDrive"     },
    { href: "/app/folder",         label: "MasterFolder",   icon: "box"           },
    { href: "/app/vault",          label: "MasterVault",    icon: "shield"        },
