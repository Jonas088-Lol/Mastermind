        ...
        <div className="flex flex-col gap-14 lg:flex-row lg:items-start lg:gap-20">
          <div className="lg:sticky lg:top-24 lg:max-w-sm">
            ...
            <p className="mt-5 text-lg text-muted-fg">
              Teste MasterMind mit deiner echten Schule — bevor du irgendetwas unterschreibst.
              Mit persönlicher Begleitung von Tag&nbsp;1.
            </p>
            <Link
              href="/onboarding"
              className={buttonVariants({ size: "lg", className: "mt-8 w-full sm:w-auto" })}
            >
              Pilotphase starten
          ...
          <ol className="flex-1">
            {steps.map((s, i) => (
              <li key={s.step} className="flex gap-6 pb-10 last:pb-0">
                <div className="flex flex-col items-center">
                  <div className="grid size-10 shrink-0 place-items-center border border-border bg-bg font-mono text-sm font-bold">
                    {s.step}
                  </div>
                  {i < steps.length - 1 && (
