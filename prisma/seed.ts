...
async function main() {
  ...
  const shopItems = [
    ...
    { slug: "streak_freeze_7",  name: "Streak-Schutz (7 Tage)", description: "Streak-Schutz für eine Woche",        category: "streak_freeze", coinPrice: 400,  icon: "❄️", rarity: "rare",      effect: "streak_freeze", effectValue: "7",  sortOrder: 22 },
    ...
    { slug: "frame_diamond", name: "Diamant-Rahmen",    description: "Diamant-Profilrahmen",       category: "cosmetic", coinPrice: 500,  icon: "💎", rarity: "epic",      effect: "frame", effectValue: "diamond", sortOrder: 42 },
    { slug: "frame_rainbow", name: "Regenbogen-Rahmen", description: "Animierter Regenbogen",      category: "cosmetic", coinPrice: 800,  icon: "🌈", rarity: "epic",      effect: "frame", effectValue: "rainbow", sortOrder: 43 },
    { slug: "frame_mythic",  name: "Mythischer Rahmen", description: "Ultraseltener Rahmen",       category: "cosmetic", coinPrice: 2000, icon: "🌌", rarity: "legendary", effect: "frame", effectValue: "mythic",  sortOrder: 44 },
    ...
    { slug: "bundle_starter", name: "Starter-Paket",  description: "Booster ×1.5 (1h) + Streak-Schutz",              category: "bundle", coinPrice: 110,  icon: "🎁", rarity: "common",    effect: "bundle", effectValue: '["boost_1_5x_1h","streak_freeze_1"]',                  sortOrder: 80 },
